...
K_BACKWARD = 0.5  # Penalty weight: backwards_penalty = K_BACKWARD * angle_diff  (if angle_diff > BACKWARD_THRESHOLD)
GRASS_DRIVING_PENALTY = 0.05 # penalty to each step that cars drive on grass
